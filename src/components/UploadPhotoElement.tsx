...
const UploadPhotoElement: React.FC<formElementProps> = ({ title, name, onImageUpload }) => {
  ...
  return (
    ...
    <div className='flex items-center flex-col text-center mt-1 w-full text-neutral-300 py-6 px-4 rounded-md border-dashed border bg-neutral-300/15 hover:bg-neutral/20'>
    ...
    {imageFail ? (
        ...
        <p className='text-xs md:text-sm mt-2 text-neutral-500 inconsolata-regular'>
            <InformationIcon hasError={false} />
